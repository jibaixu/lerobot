...
def main():
    ...
    output_directory = Path("outputs/train/panda_diffusion")
    ...
    dataset_metadata = LeRobotDatasetMetadata("/data1/jibaixu/datasets/ManiSkill/MultiTask-v1/panda_wristcam")
